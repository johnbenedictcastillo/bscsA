      ...
      this.el.addEventListener(
        ...
        function (e) {
            ...
            if(void.getAttribute("animation-mixer").clip === "Animation"){
                vois.setAttribute("animation-mixer", "clip: Static Pose")   
                this.audio.pause()
                this.audio.currentTime = 0
            }else{
                void.setAttribute(
                    "animation-mixer",
                    "clip: Animation; loop: repeat; timeScale: 3.5"
                    )
                    this.audio.play()
		 ...
		 this.el.addEventListener('mouseleave', function (e) {
			...
			let void = document.querySelector('#void-model')
		    void.setAttribute('animation-mixer', "clip: Animation; loop: repeat; timeScale: 2");
                    this.audio.play();
